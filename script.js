...
for (var i = 0; i < blocks.length; i += 1) {
	blocks[i].style.backgroundColor = "#808080"; //grey
}
...
while (start <= end) {
	...
	blocks[mid].style.backgroundColor = "#FF4949"; //red
	...
	blocks[mid].style.backgroundColor = "#13CE66"; //green
	flag = 1;
	break;
	}
	...
	blocks[mid].style.backgroundColor = "#808080"; //grey
	} else {
	start = mid + 1;
	blocks[mid].style.backgroundColor = "#808080";
	}
}
if (flag === 0) {
